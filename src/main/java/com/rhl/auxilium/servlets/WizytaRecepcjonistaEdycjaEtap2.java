...
@WebServlet("/PrzejdzDoEtapu2Recepcjonista.do")
public class WizytaRecepcjonistaEdycjaEtap2 extends HttpServlet {
	private static final long serialVersionUID = 12L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WizytaRecepcjonistaEdycjaEtap2() {
        super();
        // TODO Auto-generated constructor stub
    }
    
    static Logger log = Logger.getLogger(WizytaRecepcjonistaEdycjaEtap2.class);
