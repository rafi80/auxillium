...
@WebServlet("/ZarejestrujPacjentaNaWizyte.do")
public class WizytaPacjentZarejestruj extends HttpServlet {
	private static final long serialVersionUID = 12L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WizytaPacjentZarejestruj() {
        super();
        // TODO Auto-generated constructor stub
    }
    
    static Logger log = Logger.getLogger(WizytaPacjentZarejestruj.class);
