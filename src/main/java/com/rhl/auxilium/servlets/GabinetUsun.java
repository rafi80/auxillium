...
/**
 * Servlet implementation class GabinetUsun
 */

@WebServlet("/UsunGabinet.do")
public class GabinetUsun extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try{	
				...
				gabinetDoEdycji.zdezaktywuj(Integer.parseInt(request.getParameter("usuwaneId")));
