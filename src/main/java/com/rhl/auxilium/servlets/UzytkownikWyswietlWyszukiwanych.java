...
@WebServlet("/WyszukajUzytkownika.do")
public class UzytkownikWyswietlWyszukiwanych extends HttpServlet {
	private static final long serialVersionUID = 12L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UzytkownikWyswietlWyszukiwanych() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try{	
				...
				request.getRequestDispatcher("wyswietlWyszukiwanychUzytkownikow.jsp").forward(request, response);
		} finally {
			out.close();
		}
	}
