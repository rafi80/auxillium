...
@WebServlet("/WyswietlOpisWizytyLekarz.do")
public class OpisWizytyLekarzWyswietl extends HttpServlet {
	private static final long serialVersionUID = 12L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OpisWizytyLekarzWyswietl() {
        super();
        // TODO Auto-generated constructor stub
    }
    
    static Logger log = Logger.getLogger(OpisWizytyLekarzWyswietl.class);
